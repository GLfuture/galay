...
inline Type* RoundRobinLoadBalancer<Type>::Select()
{
...
template<typename Type>
inline Type* WeightRoundRobinLoadBalancer<Type>::Select()
{
    uint32_t index = m_index.load(std::memory_order_relaxed);
...
template<typename Type>
inline Type* RandomLoadBalancer<Type>::Select()
{
...
template<typename Type>
inline Type* WeightedRandomLoadBalancer<Type>::Select()
{
