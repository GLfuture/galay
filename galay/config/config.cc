...
// tcp server config
galay::Tcp_Server_Config::Tcp_Server_Config(uint16_t port, uint32_t backlog, uint32_t recv_len,int conn_timeout,Engine_Type type,int sche_wait_time,int max_event_size,int threadnum)
    : m_port(port), m_backlog(backlog), m_max_rbuffer_len(recv_len),m_conn_timeout(conn_timeout),Config(type,sche_wait_time,max_event_size,threadnum)
{
}
...
galay::Tcp_SSL_Server_Config::Tcp_SSL_Server_Config(uint16_t port, uint32_t backlog, uint32_t recv_len,int conn_timeout,long ssl_min_version,long ssl_max_version
, uint32_t ssl_accept_max_retry, const char *cert_filepath, const char *key_filepath,Engine_Type type,int sche_wait_time,int max_event_size,int threadnum)
        : Tcp_Server_Config(port, backlog, recv_len,conn_timeout,type,sche_wait_time,max_event_size,threadnum)
...
// http server config
galay::Http_Server_Config::Http_Server_Config(uint16_t port, uint32_t backlog, uint32_t recv_len,int conn_timeout,Engine_Type type,int sche_wait_time,int max_event_size,int threadnum)
    : Tcp_Server_Config(port, backlog, recv_len,conn_timeout,type,sche_wait_time,max_event_size,threadnum)
{
}
...
galay::Https_Server_Config::Https_Server_Config(uint16_t port, uint32_t backlog, uint32_t recv_len , int conn_timeout,long ssl_min_version,long ssl_max_version
    ,uint32_t ssl_accept_max_retry, const char *cert_filepath, const char *key_filepath,Engine_Type type,int sche_wait_time,int max_event_size,int threadnum)
    : Tcp_SSL_Server_Config(port, backlog, recv_len , conn_timeout, ssl_min_version, ssl_max_version, ssl_accept_max_retry
...
galay::Udp_Server_Config::Udp_Server_Config(uint16_t port,Engine_Type type,int sche_wait_time,int max_event_size,int threadnum)
