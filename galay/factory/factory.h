...
namespace galay
{
    ...
    public:
        ...
        */
        ...
        static Tcp_Server_Config::ptr create_tcp_server_config(uint32_t backlog,uint32_t max_rbuffer_len,Engine_Type type, int sche_wait_time,int max_event_size,int conn_timeout, int threadnum);

        //tcp ssl
        static Tcp_SSL_Server_Config::ptr create_tcp_ssl_server_config(long ssl_min_version,long ssl_max_version
        ...
        static Tcp_SSL_Server_Config::ptr create_tcp_ssl_server_config(uint32_t backlog,uint32_t max_rbuffer_len, long ssl_min_version , long ssl_max_version
        ...
        //http
        static Http_Server_Config::ptr create_http_server_config(Engine_Type type, int sche_wait_time = -1,int conn_timeout = -1, int threadnum = 1);
        static Http_Server_Config::ptr create_http_server_config(Http_Server_Config &&config);
        static Http_Server_Config::ptr create_http_server_config(uint32_t backlog,uint32_t max_rbuffer_len,Engine_Type type,int sche_wait_time,int max_event_size,int conn_timeout, int threadnum );


        //https
        static Https_Server_Config::ptr create_https_server_config(long ssl_min_version,long ssl_max_version
            , const char* cert_filepath,const char* key_filepath,Engine_Type type, int sche_wait_time = -1,int conn_timeout = -1, int threadnum = 1);
        static Https_Server_Config::ptr create_https_server_config(Https_Server_Config &&config);
        static Https_Server_Config::ptr create_https_server_config(uint32_t backlog,uint32_t max_rbuffer_len, long ssl_min_version , long ssl_max_version, 
